...
- [X] T103 [US5] `rank-cost` für die achtzehn Fähigkeiten in `rpg-plugin/src/main/resources/abilities.yml` eintragen — **als Platzhalter auf je einen Coin** (Entscheidung vom 2026-08-23). Die Kostenprüfung ist damit im Spiel auslösbar, ohne ein Preisgefüge zu behaupten, das nie besprochen wurde; `ShippedAbilityConfigTest` hält fest, dass alle achtzehn gleich sind
