...
- [ ] T030 `SixRegionsCoverTheCurveTest` in `rpg-core/src/test/java/rpg/core/zone/` — die Levelbänder der ausgelieferten Zonen decken **1 bis zur Maximalstufe aus `progression.yml` lückenlos und ohne Überlappung** ab. Bricht absichtlich, wenn jemand die XP-Kurve verlängert, ohne eine Region zu ergänzen
